...
@Composable
fun QuestsScreen(viewModel: MainViewModel, navController: NavController) {
    ...
    when (val localState = screenState) {
        ...
        is ScreenState.SuccessLoaded -> QuestsContent(viewModel, localState.quests, navController)
    }
}